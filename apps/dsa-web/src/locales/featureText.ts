...
export const TRADING_TEXT = {
  zh: {
    documentTitle: '交易 - DSA',
    title: '交易控制台',
    description: '系统状态、信号管理、订单追踪与风险配置',
    overview: '概览',
    trade: '交易',
    history: '历史',
    sandbox: '沙盒',
    ...
    prod: '实盘',
    modeLabel: '交易模式',
    tigerConnected: 'Tiger 连接',
    tigerConnectedYes: '已连接',
    tigerConnectedNo: '未连接',
    marketStatus: '市场状态',
    netValue: '净资产',
    cash: '现金',
    buyingPower: '购买力',
    ...
    actionHold: '持有',
    quantity: '数量',
    quantityPlaceholder: '可选',
    confidence: '置信度',
    confidencePlaceholder: '0.0 - 1.0',
    rationale: '理由',
    rationalePlaceholder: '交易依据（可选）',
    submitSignal: '提交信号',
    submitting: '提交中...',
    signalSuccess: '信号创建成功',
    signalError: '信号创建失败',
    pendingSignals: '待处理信号',
    noPendingSignals: '暂无待处理信号',
    confirm: '确认',
    reject: '拒绝',
    confirming: '确认中...',
    rejecting: '拒绝中...',
    ...
    loading: '加载中...',
    errorTitle: '加载失败',
    overviewLoading: '正在加载概览数据',
    riskConfig: '风险配置',
    strategies: '策略列表',
    maxPositionPct: '单标的最大仓位占比',
    maxDailyLossPct: '每日最大亏损占比',
    maxOrderValue: '最大订单金额',
    maxOrdersPerMin: '每分钟最大订单数',
    maxDailyOrders: '每日最大订单数',
    signalTtlMinutes: '信号有效时间（分钟）',
    enabled: '已启用',
    disabled: '已停用',
  },
  en: {
    documentTitle: 'Trading - DSA',
    title: 'Trading Console',
    description: 'System status, signal management, order tracking, and risk configuration',
    overview: 'Overview',
    trade: 'Trade',
    history: 'History',
    sandbox: 'Sandbox',
    ...
    tigerConnected: 'Tiger connected',
    tigerConnectedYes: 'Connected',
    tigerConnectedNo: 'Disconnected',
    ...
    confidencePlaceholder: '0.0 - 1.0',
    rationale: 'Rationale',
    rationalePlaceholder: 'Trading rationale (optional)',
    submitSignal: 'Submit signal',
    submitting: 'Submitting...',
    signalSuccess: 'Signal created successfully',
    signalError: 'Failed to create signal',
    ...
    noSignalHistory: 'No signal history',
    ...
    overviewLoading: 'Loading overview data',
    riskConfig: 'Risk config',
    strategies: 'Strategies',
    maxPositionPct: 'Max position % per symbol',
    maxDailyLossPct: 'Max daily loss %',
    maxOrderValue: 'Max order value',
    maxOrdersPerMin: 'Max orders per minute',
    maxDailyOrders: 'Max daily orders',
    signalTtlMinutes: 'Signal TTL (minutes)',
    enabled: 'Enabled',
    disabled: 'Disabled',
  },
} as const;
